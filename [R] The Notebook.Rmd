...
2.15.[vector] validate data value meets expected value
...
2.16.[vector] validate true/false data value
...
2.17.[vector] search match true/false data value
...
2.18.[vector] check if each data value in vector 1 is in vector 2
...
2.19.[vector] check if  data value in vector 1 is/ is not  in vector 2
...
4.2.19.[data_frame] scatter plot
...
2.21.[vector] floor ceiling threshold
...
2.21.1.[vector] length round sample 
...
4.2.21.[vector] histogram skewness check
...
4.2.21.[vector] scatter plot empirical cumulative distribution = probability distribution of an outcome to happen
...
4.2.21.[vector] box plot 

```{r}
boxplot(heights_sex_male$height,heights_sex_female$height)
```

4.2.21.[vector] QQ plot  = normality of probability distribution test
...
2.22.1[vector] random distribution of factor 
...
2.22.3.[vector] distribution of factor seed sample repeatedly 
...
2.23.[vector] central limit theorem 
...
4.2.23.[vector] histogram central limit theorem 
...
```
2.23.1.[vector] central limit theorem proportion of observations between average plus standard deviaiton
